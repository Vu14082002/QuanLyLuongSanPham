...
//        this.txtMaNhanVien.setBackground(new Color(0, 0, 0, 1));
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Mẫ công đoạn");
        jPanel5.add(jLabel16, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 20, 190, 40));
        ...
        jPanel5.add(aaaa, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 40, 660, 280));

        jPanel3.add(jPanel5, java.awt.BorderLayout.PAGE_START);

        jScrollPane1.setBackground(new java.awt.Color(255, 255, 255));
        jScrollPane1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Danh sách công đoạn", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 16))); // NOI18N
        ...
        tbNhanVien.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã sản phẩm", "Tên sản phẩm", "Mã công đoạn", "Tên  công đoạn", "Số lượng cần làm", "Giá tiền 1 sản phẩm", "Thời hạn", "Mưc độ hoàn thành"
            }
        ) {
            boolean[] canEdit = new boolean [] {

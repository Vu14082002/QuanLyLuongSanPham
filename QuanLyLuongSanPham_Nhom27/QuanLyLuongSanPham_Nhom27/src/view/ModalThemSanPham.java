 ...
 * @author Student
 */
public class ModalThemSanPham extends javax.swing.JFrame {
...
//        System.out.println(panelBorder1.getColorModel());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModalThemSanPham.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ModalThemSanPham().setVisible(true);
            }
        });
    }

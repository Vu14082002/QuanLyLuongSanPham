 ...
 * @author Student
 */
public class ThemCongNhanView extends javax.swing.JFrame {

    /**
     * Creates new form modalThemNhanSuView
     */
    public ThemCongNhanView() {
        initComponents();
        init();
    }
...
//        this.txtLuongNhanVien.setBackground(new Color(0,0,0,1));
    ...
    private void initComponents() {
        ...
        lbTieuDeCapNhatNhanVien.setText("Thêm công nhân");
        ...
        lbMaNhanVien.setText("Mã công nhân");
        ...
        lbNgaySinhNhanVien.setBounds(200, 500, 120, 18);

        lbPhongBanNhanVien.setFont(new java.awt.Font("Segoe UI", 0, 13)); // NOI18N
        lbPhongBanNhanVien.setText("Tổ/Nhóm");
        panelBorder1.add(lbPhongBanNhanVien);
        lbPhongBanNhanVien.setBounds(200, 530, 130, 30);
        ...
        lbChucVuNhanVien.setBounds(200, 570, 120, 30);
        ...
        lbNgayVaoLamNhanVien.setBounds(200, 610, 130, 30);
        ...
        btnLuuNhanVien.setBounds(190, 670, 130, 40);
        ...
        btnThoatNhanVien.setBounds(410, 670, 130, 40);
...
//        int respone=fileChooser.showOpenDialog(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemCongNhanView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemCongNhanView().setVisible(true);
            }
        });
    }

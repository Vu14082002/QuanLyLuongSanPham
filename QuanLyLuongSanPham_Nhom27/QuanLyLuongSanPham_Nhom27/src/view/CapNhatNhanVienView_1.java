 ...
 * @author December
 */
public class CapNhatNhanVienView_1 extends javax.swing.JPanel {
    ...
    public CapNhatNhanVienView_1() throws Exception {
        initComponents();
        excute();
        taiDuLieuLenBang();
            ...
            if (JOptionPane.showConfirmDialog(null, "Bạn có chắc muốn xóa?", "Xóa nhân viên", JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION) {
                if (daoNhanVien.xoaMotNhanVienTheoMa(tblNhanVien.getValueAt(tblNhanVien.getSelectedRow(), 1).toString())) {
                    ...
                    try {
                        ...
                        Logger.getLogger(CapNhatNhanVienView_1.class.getName()).log(Level.SEVERE, null, ex);
                    }
                } else {

...
public class temp extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel5.add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 140, 100, 20));
        ...
        jPanel5.add(jLabel29, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 110, 100, 20));

        txtMaNhanVien4.setText("jTextField1");
        txtMaNhanVien4.setBorder(null);
        jPanel5.add(txtMaNhanVien4, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 130, 280, -1));

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel8.setText("Số điên thoại:");
        jPanel5.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 130, 150, -1));

        jLabel6.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel6.setText("Họ và tên:");
        jPanel5.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 80, 150, -1));
        jPanel5.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, 282, 10));

        jLabel1.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel1.setText("Phòng ban:");
        jPanel5.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 30, 120, 30));

        jLabel10.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel10.setText("Số CCCD");
        jPanel5.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 180, 150, -1));

        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Phòng tài chính", "Phòng kế toán" }));
        jPanel5.add(jComboBox1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 30, 140, 30));

        txtMaNhanVien5.setText("jTextField1");
        txtMaNhanVien5.setBorder(null);
        jPanel5.add(txtMaNhanVien5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 180, 280, -1));
        jPanel5.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 282, 10));

        txtMaNhanVien3.setText("jTextField1");
        txtMaNhanVien3.setBorder(null);
        jPanel5.add(txtMaNhanVien3, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 80, 280, -1));

        txtMaNhanVien.setText("jTextField1");
        txtMaNhanVien.setBorder(null);
        jPanel5.add(txtMaNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 30, 280, 20));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel2.setText("Mã nhân viên:");
        jPanel5.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 150, -1));

        jLabel9.setForeground(new java.awt.Color(255, 0, 0));
        jLabel9.setText("đoạn này thông báo lỗi");
        jPanel5.add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 280, 20));
        jPanel5.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 50, 282, 10));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        jLabel12.setText("Giới tính");
        jPanel5.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 90, 110, 30));

        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Tất cả", "Nam", "Nữ" }));
        jPanel5.add(jComboBox2, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 90, 140, 30));

        jLabel11.setForeground(new java.awt.Color(255, 0, 0));
        jLabel11.setText("đoạn này thông báo lỗi");
        jPanel5.add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 200, 280, 20));

        jLabel14.setForeground(new java.awt.Color(255, 0, 0));
        jLabel14.setText("đoạn này thông báo lỗi");
        jPanel5.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 100, 280, 20));

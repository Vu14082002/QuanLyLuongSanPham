...
//    }
    ...
    private void initComponents() {
        ...
        add(pnPieChar, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 40, 420, 310));

        pnHitogramChar.setLayout(new java.awt.BorderLayout());
        add(pnHitogramChar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 550, 310));

        pnBarChar.setLayout(new java.awt.BorderLayout());
        add(pnBarChar, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 440, 620, 250));
        ...
        add(jScrollPane3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 460, 530, 230));
        ...
        add(cmbNam, new org.netbeans.lib.awtextra.AbsoluteConstraints(780, 390, 160, 40));

...
//        tbTrangChu.getTableHeader().setForeground(new Color(255,255,255));
    ...
    private void initComponents() {
        ...
        pnlPhongBan.add(txtMaPhongBan, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 30, 200, 30));
        ...
        pnlPhongBan.add(lblTenPhongBan, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 85, 190, 50));
        ...
        pnlPhongBan.add(txtTenPhongBan, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 90, 200, 30));
        ...
        pnlPhongBan.add(lblMaPhongBan, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 25, 190, 50));

        lblSoLuongNhanVien.setFont(new java.awt.Font("Segoe UI", 0, 16)); // NOI18N
        lblSoLuongNhanVien.setText("Số lượng nhân viên:");
        pnlPhongBan.add(lblSoLuongNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 135, 190, 60));
        ...
        pnlPhongBan.add(txtSoLuongNhanVien, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 150, 200, 30));

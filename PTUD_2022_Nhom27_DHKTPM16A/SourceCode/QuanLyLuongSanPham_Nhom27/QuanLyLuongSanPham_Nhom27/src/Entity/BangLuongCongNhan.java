...
public class BangLuongCongNhan {
    ...
    private void setMaBangLuong(String maBangLuong) throws Exception {
        ...
        } else if (!maBangLuong.matches("^LC[1-9][0-9]{5}$")) {
            throw new Exception("Mã bảng lương phải theo dạng LCxxxxxx với x là các kí tự số x đầu tiền từ [1-9] x sau từ [0-9]");
        } else {
